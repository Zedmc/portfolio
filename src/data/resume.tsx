...
export const DATA = {
  name: "Zié Mohamed Coulibaly",
  initials: "ZMC",
  url: "https://zedmc.io",
  location: "Greater Montréal Area",
  locationLink: "https://www.google.com/maps/place/montreal",
  description:
    "Frontend Software Developer focused on transforming code into captivating and seamless digital experiences.",
  summary:
    // "At the end of 2022, I quit my job as a software engineer to go fulltime into building and scaling my own SaaS businesses. In the past, [I pursued a double degree in computer science and business](/#education), [interned at big tech companies in Silicon Valley](https://www.youtube.com/watch?v=d-LJ2e5qKdE), and [competed in over 21 hackathons for fun](/#hackathons). I also had the pleasure of being a part of the first ever in-person cohort of buildspace called [buildspace sf1](https://buildspace.so/sf1).",
    "A few years ago, I started coding because I was fascinated by how random characters could create something as vast as the internet. Now, with experience, I see how it all fits together to build websites.\n\nThese days, I focus on creating accessible, user-friendly interfaces, primarily with React and JavaScript. I have an eye for design, which leads me to pixel-perfect CSS, and I enjoy crafting beautiful, functional digital experiences.",
  avatarUrl: "/me.png",
  skills: [
    "React",
    "Vue",
  ...
  education: [
    {
      ...
      degree: "Bachelor's Degree of Economics (BE)",
  ...
  projects: [
    ...
    },
    {
      ...
      image: "",
      video: "/tomato-video.mp4",
    },
    {
      title: "Multi-Step Form",
      href: "https://zedmc-multi-step-form.netlify.app/",
      dates: "November 2023",
      active: true,
      description:
      ...
      image: "",
      video: "/form-video.mp4",
    },
    {
      title: "React Country Flag API",
      href: "https://zedmc-country-flags-api.netlify.app/",
      dates: "December 2023",
      active: true,
      description:
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/Zedmc/Country-Flags-API",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "",
